...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets/img/buku/logo.png') }}" rel="icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/" class="logo d-flex align-items-center">
        <img src="{{ asset('assets/img/buku/logo.png') }}" alt="">
        <span class="d-none d-lg-block">BilikAdmin</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Atina Uswati</span>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Request::is('dashboard/peminjaman') ? 'active' : '' }}"" href="/dashboard/peminjaman">
  ...
  <script>
    const sidebar_items = document.querySelectorAll('sidebar-nav .nav-link')
    
    function toggleActive(e) {
        sidebar_items.forEach(function(v, k) {
            v.classList.remove('active')
        })
        e.closest('sidebar-nav .nav-link').classList.add('active')
    }
  </script>
